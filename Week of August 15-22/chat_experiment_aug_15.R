...
#setwd("/Users/ashimdatta/Enterprise/chat experiments/Week of August 15-22")
getwd()
library("DBI")
library("RPostgreSQL")
library("sqldf")
...
applicationid_list<-unique(masterdata$applicationid)
...
test_data<-chat_out_data[which(chat_out_data$applicationid=='09e5d674-d88a-403a-93eb-284ea96cb154'|
                                 chat_out_data$applicationid=='b7d7a15a-c97a-49d0-ae71-e5aa771f555d'),]
